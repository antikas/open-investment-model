...
- **Three owned entities and a key partition.** BD-11 owns DR-04 Margin & Collateral Balance (SD-11.4), E-26 Collateral Position (SD-11.5) and the cash partition of E-25 Account (SD-11.7, co-equal with SD-12.5 for the safekeeping partition and SD-15.4 for the register partition). Facility structures remain process artefacts.
...
- **Owns** DR-04 Margin & Collateral Balance (SD-11.4); E-26 Collateral Position (SD-11.5) — the generic posted / received collateral record DR-04 and PB-10 both reference; and the cash partition of E-25 Account (SD-11.7, co-equal with SD-12.5 for the safekeeping partition and SD-15.4 for the register partition). Facility structures remain process artefacts.

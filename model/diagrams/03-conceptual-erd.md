...
- **Specialisations.** The 48 specialisation entities across the five packs (a fund as an Instrument, a deal / investment opportunity as the direct-deal pipeline record, a capital call as a Transaction, a fund NAV as a Valuation, a directly-held real asset as an Instrument, a direct loan as an Instrument, an issued fund product as an Instrument, a share or unit class as an Instrument, an investor unitholding as a Holding / Position, a dealing order as a Transaction, a fund distribution event as a Transaction, a fee accrual as a Valuation, an investor tax statement as a Document Metadata (E-15), a service-provider appointment record, an omnibus account as an Account (E-25), an ETF creation/redemption order as a Transaction, an ETF creation basket (portfolio composition file), and an ETF authorised-participant agreement) are in the [pack READMEs](../entities/INDEX.md).

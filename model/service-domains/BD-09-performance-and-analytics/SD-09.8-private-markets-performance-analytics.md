...
- **ILPA** — the ILPA Reporting Template standardises the call / distribution / NAV data this Service Domain consumes, and reports IRR and the multiples gross and net, at fund and investment level — which is why those distinctions are explicit operations above.

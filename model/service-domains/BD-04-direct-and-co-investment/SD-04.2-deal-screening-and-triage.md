...
- **Inputs:** the deal pipeline (SD-04.1); the non-disclosure agreement and data-room access; the information memorandum and seller financials.
...
- **Consumes:** Legal Entity (E-01), Instrument / Asset (E-02), Direct Real Asset (RA-01); the SD-04.1 deal pipeline.
- **Owns:** none — the screening memo is an analytical artefact.
...
- The Direct Investment / deal record entity would carry the opportunity from screening into diligence.

...
- **Consumes:** E-04 Holding / Position (any `book` — reconciliation operates across both `ibor` and `abor` books, matching them against each other and against the custodian), E-05 Transaction, E-06 Cash Flow Event, PB-06 Settlement Instruction, DR-04 Margin & Collateral Balance, E-03 Portfolio / Mandate; the SD-11.4 collateral balances; the SD-12.1 IBOR; the SD-12.2 ABOR; the SD-12.4 settled-trade and settlement records; custodian holdings and cash statements via SD-12.5.
